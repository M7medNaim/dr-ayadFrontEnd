...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function getPageKey(btn) {
    ...
    var pageKey = window.location.href + '_' + category + '_' + btn.getAttribute('data-page-key');
    return pageKey;
  }
  ...
  // // استخدم الدالة countFavorites() لحساب عدد العناصر المفضلة
  // var favoritesCount = countFavorites();
  // console.log('عدد العناصر المفضلة:', favoritesCount);
...
// let lightMode = document.querySelector("input.lightMode");
// lightMode.onclick=_=>{
...
//     document.body.classList.toggle("light-theme");
//     themeStylesheet.href = document.body.classList.contains("light-theme")
//         ? "css/light-theme.css"
//         : "css/style.css";
// });
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // استرجاع حالة الزوم من localStorage إذا كانت موجودة
  const zoomValue = localStorage.getItem("zoomValue");
  if (zoomValue === "zoomed") {
      // تحقق من أن الـ checkbox محدد
